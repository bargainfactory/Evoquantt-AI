  ...
  const sharpeChart: Data[] = displayData.length > 0 ? [
    {
      ...
      marker: {
        ...
        colorscale: "Viridis",
        showscale: true,
        colorbar: { title: "Fitness", thickness: 10, len: 0.6 },
      },
      name: "Risk/Return",
    },
  ] : [];
                ...
                <div className="evo-card">
                  ...
                  <Plot
                    ...
                    layout={{
                      ...
                      yaxis: { title: "Fitness Score", gridcolor: "#161B22" },
                ...
                <div className="evo-card">
                  ...
                  <Plot
                    ...
                    layout={{
                      paper_bgcolor: "transparent", plot_bgcolor: "transparent",
                      font: { color: "#8B949E", size: 11 },
                      xaxis: { title: "Max Drawdown (%)", gridcolor: "#161B22" },
                      yaxis: { title: "Sharpe Ratio", gridcolor: "#161B22" },
